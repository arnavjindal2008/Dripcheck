      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between flex-1 gap-4 sm:gap-6">
            <div>
              <h1 className="text-3xl sm:text-4xl font-black tracking-tight text-text-primary uppercase tracking-tighter">Laundry Basket</h1>
              <p className="text-text-muted mt-1 sm:mt-2 font-medium text-sm sm:text-base">Items currently being refreshed.</p>
            </div>
          ...
          <div className="relative w-full sm:w-auto">
            ...
            <input
              ...
              className="w-full sm:w-72 bg-text-primary/5 border border-border-color text-text-primary text-sm rounded-xl sm:rounded-2xl py-3 sm:py-3.5 pl-11 sm:pl-12 pr-5 focus:outline-none focus:border-white/30 focus:ring-1 focus:ring-white/30 transition-all placeholder:text-text-primary/20"
            />
          </div>
        </div>
      </div>
          ...
          <div className="bg-background-secondary/90 backdrop-blur-2xl border border-border-color/20 rounded-[2rem] sm:rounded-[2.5rem] p-3 sm:p-4 shadow-custom flex items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                disabled={isPending}
                className="bg-green-500 text-white px-4 sm:px-6 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-black text-[9px] sm:text-[10px] uppercase tracking-widest flex items-center gap-2 hover:scale-105 active:scale-95 transition-all shadow-xl shadow-green-500/20 disabled:opacity-50"
              >
                {isPending ? <Loader2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 animate-spin" /> : <ShirtIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4" />}
                <span className="hidden xs:inline">To Wardrobe</span>
