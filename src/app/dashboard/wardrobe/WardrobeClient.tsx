    ...
    <div className="space-y-10 pb-20">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between flex-1 gap-6">
          <div>
            <h1 className="text-4xl font-black tracking-tight text-text-primary">My Wardrobe</h1>
            <p className="text-text-muted mt-2 font-medium">Your collection of style and drip.</p>
          </div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full sm:w-80 bg-text-primary/5 border border-border-color text-text-primary text-sm rounded-2xl py-4 pl-12 pr-5 focus:outline-none focus:border-white/30 focus:ring-1 focus:ring-white/30 transition-all placeholder:text-text-primary/20 shadow-inner"
          />
        </div>
      </div>
          ...
          <div className="bg-background-secondary/90 backdrop-blur-2xl border border-border-color/20 rounded-[2.5rem] p-4 shadow-custom flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                disabled={isPending}
                className="bg-blue-500 text-text-primary px-6 py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest flex items-center gap-2 hover:scale-105 active:scale-95 transition-all shadow-xl shadow-blue-500/20 disabled:opacity-50"
              >
                {isPending ? <Loader2 className="w-4 h-4 animate-spin" /> : <WashingMachine className="w-4 h-4" />}
                Laundry
              </button>
